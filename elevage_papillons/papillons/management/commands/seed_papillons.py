...
from papillons.models import ImagePapillon, Papillon, SituationGeographique
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        for item in donnees:
            ...
            if not created:
                papillon.couleur = item["couleur"]
                papillon.date_observation = item["date_observation"]
                papillon.provenance = item["provenance"]
                papillon.prix = item["prix"]
                papillon.save(update_fields=[
                    "couleur",
                    "date_observation",
                    "provenance",
                    "prix",
